...
public class CustomGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public final int LOW_SDK = 11;  //RGB888 支持的最低SDK
    ...
    public void setRenderer(Renderer renderer) {
        ...
        if (mEGLConfigChooser == null) {
        	if (Build.VERSION.SDK_INT <= LOW_SDK)
        	{
        		mEGLConfigChooser = new SimpleEGLConfigChooser(5,6,5,true);        		
        	}else {
        		mEGLConfigChooser = new SimpleEGLConfigChooser(8,8,8,true);      
			}
        }
    ...
    public void setEGLConfigChooser(boolean needDepth) {
    	SimpleEGLConfigChooser sec = null;
    	if (Build.VERSION.SDK_INT <= LOW_SDK)
    	{
    		sec = new SimpleEGLConfigChooser(5,6,5,needDepth);    		
    	}else {
    		sec = new SimpleEGLConfigChooser(8,8,8,needDepth);   
		}
        setEGLConfigChooser(sec);
    }
...
//    }
     ...
     * this interface, and then call {@link CustomGLSurfaceView#setRenderer} to
     ...
     * use the {@link CustomGLSurfaceView#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link CustomGLSurfaceView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link CustomGLSurfaceView#setEGLConfigChooser(EGLConfigChooser)}
     */
...
//                    }
     ...
     * android 2是565 android 4 是888 改成565 兼容
     */
...
////			mBlueSize = 5;
//        }
        public SimpleEGLConfigChooser(int r, int g, int b, boolean withDepthBuffer) {
        	 super(r, g, b, 0, withDepthBuffer ? 16 : 0, 0);
        }
    }
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<CustomGLSurfaceView> glSurfaceViewWeakRef) {
        ...
        public int swap() {
			...
			{
				Log.e("fu", "GLsurfaceview swap error!");
			}
...
//                    "setRenderer has already been called for this instance.");
            Log.e("fu","setRenderer has already been called for this instance.");
        }
    }
